...
import io.github.nicholas_roether.draw.DocApplet;
...
public class App extends DocApplet {
//	private PhysicsGraph<PhysicsNodeData, NullType> graph;
	private Graph<PVector, NullType> graph;
	...
	protected void populate() {
		...
		final GraphNode<PVector> nodeK = graph.addNode("K", new PVector(width / 2f + 200, height / 2f + 200));
		...
		graphComponent = new GraphComponent(graph, List.of("A"));
		document.appendChild(graphComponent);
	}

	@Override
	protected void frame() {
		graphComponent.stepPhysicsEngine(1 / frameRate);
	}
